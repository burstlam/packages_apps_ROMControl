...
public class CMDProcessor2 {
    ...
    public CMDProcessor2 setLogcatDebugging(boolean debug) {
        mDebug = debug;
        return this;
    }
    ...
    public class SH {
         ...
         * @return result of command as CommandResult2 object
         */
        @Deprecated
        public CommandResult2 runWaitFor(String command) {
        ...
        public CommandResult2 runWaitFor(Executable script) {
    ...
    public boolean canSU(boolean force_check) {
        if (can_su == null || force_check) {
            CommandResult2 r = su.runWaitFor("id");
