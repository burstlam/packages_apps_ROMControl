...
public class CommandResult2 implements Parcelable {
    ...
    public CommandResult2(Executable executableScript,
                         long startTime,
    ...
    public CommandResult2(Parcel inParcel) {
    ...
    // setters
    public CommandResult2 setExit_value(Integer exit_value) {
        this.exit_value = exit_value;
        return this;
    }

    public CommandResult2 setStdout(String stdout) {
        this.stdout = stdout;
        return this;
    }

    public CommandResult2 setStderr(String stderr) {
        this.stderr = stderr;
        return this;
    }

    public CommandResult2 setEndTime(long endTime) {
        ...
        if (getExit_value() != 0
            ...
            try {
                ...
                if (skipOfflineCpu) {
                    ...
                    errorWriter.write(lineEnding);
                    errorWriter.write("CommandResult2 {" + this.toString() + '}');
                    errorWriter.write(lineEnding);
                }
                errorWriter.write(lineEnding);
            } catch (IOException e) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommandResult2)) return false;

        CommandResult2 that = (CommandResult2) o;
