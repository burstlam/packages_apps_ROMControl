...
public class InterfaceAppSidebar extends AOKPPreferenceFragment implements
    ...
    private SeekBarPreferenceExt mTransparencyPref;
    private ListPreference mPositionPref;
    private CheckBoxPreference mHideLabelsPref;
    private SeekBarPreferenceExt mTriggerWidthPref;
    private SeekBarPreferenceExt mTriggerTopPref;
    private SeekBarPreferenceExt mTriggerBottomPref;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        addPreferencesFromResource(R.xml.interface_app_sidebar);
        ...
        mTransparencyPref = (SeekBarPreferenceExt) findPreference(KEY_TRANSPARENCY);
        ...
        mTriggerWidthPref = (SeekBarPreferenceExt) findPreference(KEY_TRIGGER_WIDTH);
        ...
        mTriggerTopPref = (SeekBarPreferenceExt) findPreference(KEY_TRIGGER_TOP);
        mTriggerTopPref.setValue(Settings.System.getInt(getContentResolver(),
                Settings.System.APP_SIDEBAR_TRIGGER_TOP, 0));
        mTriggerTopPref.setOnPreferenceChangeListener(this);

        mTriggerBottomPref = (SeekBarPreferenceExt) findPreference(KEY_TRIGGER_BOTTOM);
