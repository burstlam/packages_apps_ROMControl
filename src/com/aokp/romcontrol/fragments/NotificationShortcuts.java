...
import com.aokp.romcontrol.util.ShortcutPickHelper;
...
public class NotificationShortcuts extends AOKPPreferenceFragment implements ShortcutPickHelper.OnPickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShowWifiName.setChecked(Settings.System.getIntForUser(getContentResolver(),
                Settings.System.NOTIFICATION_SHOW_WIFI_SSID, 0, UserHandle.USER_CURRENT_OR_SELF) == 1);
        mShowWifiName.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference,
                        Object newValue) {
                Settings.System.putInt(mCr, NOTIFICATION_SHOW_WIFI_SSID, (Boolean) newValue ? 1 : 0);
                return true;
            }
        });
