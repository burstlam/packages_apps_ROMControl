...
public class LockscreenTargets extends AOKPPreferenceFragment implements ShortcutPickHelper.OnPickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mIsScreenLarge = !Helpers.isPhone(mActivity) ||
        ...
        mIconPick = new IconPick(mActivity, this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == IconPick.REQUEST_PICK_SYSTEM || requestCode == IconPick.REQUEST_PICK_GALLERY
                || requestCode == IconPick.REQUEST_PICK_ICON_PACK) {
            mIconPick.onActivityResult(requestCode, resultCode, data);
                ...
                public void onClick(View v) {
                    if (!mDialogLabel.getText().equals(EMPTY_LABEL)) {
                        try {
                            ...
                            mIconPick.pickIcon(getId(), mImageTmp);
                        } catch (IOException e) {
                        }
                    }
                }
    ...
    public void iconPicked(int requestCode, int resultCode, Intent in) {
        ...
        String pkgName = null;
        String iconSource = null;
        if (requestCode == IconPick.REQUEST_PICK_GALLERY) {
        ...
        } else if (requestCode == IconPick.REQUEST_PICK_SYSTEM) {
            String resourceName = in.getStringExtra(IconPick.RESOURCE_NAME);
        ...
        } else if (requestCode == IconPick.REQUEST_PICK_ICON_PACK && resultCode == Activity.RESULT_OK) {
            String resourceName = in.getStringExtra(IconPick.RESOURCE_NAME);
            pkgName = in.getStringExtra(IconPick.PACKAGE_NAME);
            try {
